          ...
          <div className="lg:col-span-8">
            ...
            <div className="mt-12 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button className="px-4 py-2 rounded-lg hover:bg-primary/10 text-primary">2</button>
                <button className="px-4 py-2 rounded-lg hover:bg-primary/10 text-primary">3</button>
                <span className="px-4 py-2 text-muted-foreground">...</span>
                <button className="px-4 py-2 rounded-lg hover:bg-primary/10 text-primary">12</button>
              </div>
              <button className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary/10 text-primary hover:bg-primary/20 transition-colors">
                Next
